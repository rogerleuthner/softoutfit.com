        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="bs-component">
                    <div class="jumbotron">
                        <h1 style="margin-right: 100px;">Ca&ntilde;ones Software Outfitter</h1>
                        <p>Software developers and computer application advisors.</p>
...
We work with you to:
                    ...
                    <p>
                    <ul>
<li>Recommend computer solutions that will work for your business.</li>
<li>Design, develop, implement and maintain your business information architecture.</li>
<li>Give you ideas on how to take advantage of new technology.</li>
<li>Provide written critiques of existing systems and/or development.</li>
                    </ul>
                    </p>
                    <p>
...
This web site is an example of using open source tools to generate a consistent look and feel from a set of specifications and content. It"s an example of how we use open source tools to improve your operations" competitiveness and cost effectiveness.
                    ...
                    <p>
Please browse the site to learn a little about the <strong>Ca&ntilde;ones Software Outfitter</strong> and some of the people who make the company.
                    </p>
                </section>
...
We can help:
                    <ul>
<li>Recommend computer hardware and software appropriate to your requirements.</li>
<li>Setup/debug your home network - wired or wireless.</li>
<li>Install/setup software and/or hardware upgrades.</li>
<li>Debug hardware/software problems.</li>
<li>Help you preserve your data.</li>
<li>Build computers or networks from scratch. You see every component that goes in, so know exactly what you"re getting. Of course, we"ll also work with you so that you buy what you need, and ONLY what you need.</li>
                    </ul>
                    </p>
                    <p>
Let Ca&ntilde;ones Software Outfitter do the job for you - we"ll recommend a cost effective (read: "cheap, yet sufficient") hardware and software solution, then do the setup for a fixed fee agreed upon up front. Since you buy the hardware from a third party, you never have to pay markups to us. You can buy your equipment from your preferred vendor, or we can tell you where to get good stuff cheap!!
                    </p>
                    <p>
